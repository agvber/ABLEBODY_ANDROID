package com.example.ablebody_android.brand.data
...
val fakeBrandDetailItemResponseData = BrandDetailItemResponseData(
    content = listOf(
        BrandDetailItemResponseData.Item(
            id = 52,
            name = "나이키 스포츠웨어 에센셜",
            price = 35000,
            salePrice = null,
            brandName = "NIKE",
            image = "https://ablebody-bucket.s3.ap-northeast-2.amazonaws.com/item/ABLE-0000052.png",
            isPlural = false,
        ...
        BrandDetailItemResponseData.Item(
            ...
            salePrice = null,
            brandName = "NIKE",
            image = "https://ablebody-bucket.s3.ap-northeast-2.amazonaws.com/item/ABLE-0000039.png",
            isPlural = false,
    ...
    pageable = BrandDetailItemResponseData.Pageable(
        sort = BrandDetailItemResponseData.Sort(empty = false, sorted = true, unsorted = false),
        offset = 0,
        pageNumber = 0,
        pageSize = 20,
        paged = true,
...
val fakeBrandDetailCodyResponseData = BrandDetailCodyResponseData(
    content = listOf(
    ...
    pageable = BrandDetailCodyResponseData.Pageable(
        sort = BrandDetailCodyResponseData.Sort(empty = false, sorted = true, unsorted = false),
        offset = 0,
        pageNumber = 0,
        pageSize = 20,
        paged = true,
