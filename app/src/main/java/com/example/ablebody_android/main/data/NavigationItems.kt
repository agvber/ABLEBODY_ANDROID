...
enum class NavigationItems(
    ...
    Bookmark(labelText ="북마크", imageEnableResourceID = R.drawable.ic_navigation_bookmark_enable, imageDisableResourceID = R.drawable.ic_navigation_bookmark_disable),
